...
def percent_generator(data_path: str, system_tests_path: str, username: str, password: str):
    ...
    config_paths = {
        ...
        "favorita":
        {
            ...
            "query_config_path": "test_real_data/queries/qr/favorita/query_specs_oil_root.conf"
        },
        "yelp":
        {
            "db_config_path": "test_real_data/databases/yelp/database_specs_yelp.conf",
            "query_config_path": "test_real_data/queries/qr/yelp/query_specs_user_root.conf"
        }
    }
